              ...
              <form method="POST" action="/admin/cadastrar-portaria/<?php echo htmlspecialchars( $portaria["idPortaria"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-10">
                    ...
                    <input type="text" class="form-control" id="exampleInputDescricao" name="txtDescricao" value="<?php echo htmlspecialchars( $portaria["txtDescricao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                  </div>

                  <div class="form-group col-md-10">
                    <label for="exampleInputArquivo">Nome do arquivo</label>
                    <input type="text" class="form-control" id="exampleInputArquivo" name="txtNomeArquivo" value="<?php echo htmlspecialchars( $portaria["txtNomeArquivo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                  </div>
