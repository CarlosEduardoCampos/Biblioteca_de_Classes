        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="/admin/cadastrar-portaria" enctype="multipart/form-data">
                <div class="card-body row">

                  <div class="form-group col-md-10">
                    <label for="exampleInputName">Nome da Portaria</label>
                    <input type="text" class="form-control" id="exampleInputName" name="txtNomePortaria">
                  </div>
