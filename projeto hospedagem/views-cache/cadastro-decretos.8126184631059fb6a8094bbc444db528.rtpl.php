        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="/admin/cadastrar-decretos" enctype="multipart/form-data">
                <div class="card-body row">

                  <div class="form-group col-md-10">
                    <label for="exampleInputName">Nome do Decreto</label>
                    <input type="text" class="form-control" id="exampleInputName" name="txtNomeDecreto">
                  </div>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <select name="intStatus" id="exampleInputStatus" class="form-control">
                      ...
                      <option value="0"> Esperando Votação  </option>
                      <option value="1"> Votado </option>
                    </select>
                  </div>
