            ...
            <div class="card card-primary">
              ...
              <form method="POST" action="/admin/editar-licitacao/<?php echo htmlspecialchars( $licitacao["idLicitacao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" enctype="multipart/form-data">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-5">
                    <label for="exampleInputProcesso">Numero do Processo</label>
                  ...
                  <div class="form-group col-md-10">
                    ...
                    <input type="text" class="form-control" id="exampleInputDescricao" name="txtDescricao" value="<?php echo htmlspecialchars( $licitacao["txtDescricao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                  </div>
                  ...
                  <div class="form-group col-md-5">
                    ...
                    <input type="file" class="form-control" id="exampleInputArquivo" name="txtArquivo" value="<?php echo htmlspecialchars( $licitacao["txtArquivo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                  </div>
