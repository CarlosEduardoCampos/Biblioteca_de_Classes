        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="/admin/cadastrar-membrosMesa">
                <div class="card-body row">

                  <div class="form-group col-md-6">
                    <label for="exampleInputMesa">Membro Mesa</label>
                    <select name="fkMesa" id="exampleInputMesa" class="form-control">
                      ...
                      <option value="<?php echo htmlspecialchars( $value1["idMesaDiretora"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["txtNomeMesa"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                      <?php } ?>
                    </select>
                  </div>
