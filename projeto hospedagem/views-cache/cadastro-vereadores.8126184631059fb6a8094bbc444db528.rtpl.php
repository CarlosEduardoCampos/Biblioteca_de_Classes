              ...
              <form method="POST" action="/admin/cadastrar-vereadores" enctype="multipart/form-data">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-10">
                    ...
                    <input type="text" class="form-control" id="exampleInputName" name="txtNomeVereador" placeholder="Nome Completo">
                  </div>

                  <div class="form-group col-md-4">
                    <label for="exampleInputArquivo">Anexar Foto</label>
                    <input type="file" class="form-control" id="exampleInputArquivo" name="txtFotoVereador">
                  </div>
