    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/admin/anuncio" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/admin/cidade" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/admin/tipoImovel" class="nav-link">
            ...
            <li class="nav-item">
            <a href="/admin/tipoNegocio" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/admin/proprietario" class="nav-link">
