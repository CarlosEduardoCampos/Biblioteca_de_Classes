              ...
              <form method="POST" action="/admin/cadastrar-oficio/<?php echo htmlspecialchars( $oficio["idOficio"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-10">
                    ...
                    <input type="text" class="form-control" id="exampleInputArquivo" name="txtNomeArquivo" value="<?php echo htmlspecialchars( $oficio["txtNomeArquivo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                  </div>

                  <div class="form-group col-md-3">
                    <label for="exampleInputPostagem">DOficio da Postagem</label>
