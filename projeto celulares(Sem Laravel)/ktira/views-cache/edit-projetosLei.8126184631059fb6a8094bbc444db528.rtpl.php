              ...
              <form method="POST" action="/admin/cadastrar-projetosLei/<?php echo htmlspecialchars( $projetosLei["idProjetosLei"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-10">
                    ...
                    <input type="text" class="form-control" id="exampleInputDescricao" name="txtDescricao" value="<?php echo htmlspecialchars( $projetosLei["txtDescricao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                  </div>

                  <div class="form-group col-md-10">
                    <label for="exampleInputArquivo">Nome do arquivo</label>
                    <input type="text" class="form-control" id="exampleInputArquivo" name="txtNomeArquivo" value="<?php echo htmlspecialchars( $projetosLei["txtNomeArquivo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                  </div>
