        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="/admin/cadastrar-membroComissao" enctype="multipart/form-data">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-10">
                    ...
                    <select name="fkVereador" id="exampleInputVereador" class="form-control">
                      ...
                      <option value="<?php echo htmlspecialchars( $value1["idVereadores"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["txtNomeVereador"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                      <?php } ?>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-md-5">
                    ...
                    <select name="fkComissao" id="exampleInputComissao" class="form-control">
                      <option value="" > SELECT </option>
                      <?php $counter1=-1;  if( isset($comissao) && ( is_array($comissao) || $comissao instanceof Traversable ) && sizeof($comissao) ) foreach( $comissao as $key1 => $value1 ){ $counter1++; ?>
                      <option value="<?php echo htmlspecialchars( $value1["idComissoes"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["txtNomeComissoes"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                      <?php } ?>
                    </select>
                  </div>
