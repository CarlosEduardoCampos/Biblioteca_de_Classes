        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="/admin/cadastrar-indicadores">
                <div class="card-body row">

                  <div class="form-group col-md-10">
                    <label for="exampleInputName">Nome de Indicadores </label>
                    <input type="text" class="form-control" id="exampleInputName" name="txtNomeIndicao">
                  </div>
                  ...
                  <div class="form-group col-md-10">
                    ...
                    <input type="text" class="form-control" id="exampleInputArquivo" name="txtNomeAquivo">
                  </div>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <select name="fkResponsavel" id=" " class="form-control">
                      ...
                      <option value="0"> Ana Maria      </option>
