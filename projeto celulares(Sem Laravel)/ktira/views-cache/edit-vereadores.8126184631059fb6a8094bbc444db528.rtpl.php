        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="/admin/editar-vereadores/$vereadores.idVereadores" enctype="multipart/form-data">
                <div class="card-body row">

                  <div class="form-group col-md-10">
                    <label for="exampleInputName">Vereador</label>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="file" class="form-control" id="exampleInputArquivo" name="txtFotoVereador" value="<?php echo htmlspecialchars( $vereadores["txtFotoVereador"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                  </div>

                  <div class="form-group col-md-3">
                    <label for="exampleInputNacimento">Nacimento</label>
