          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="/admin/cadastrar-pescasReparo">
                    <div class="card-body row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="number" class="form-control" id="exampleInputValor" name="Valor">
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select name="Smartphone" id="exampleInputOrigem" class="form-control">
                                ...
                                <?php $counter1=-1;  if( isset($smartphones) && ( is_array($smartphones) || $smartphones instanceof Traversable ) && sizeof($smartphones) ) foreach( $smartphones as $key1 => $value1 ){ $counter1++; ?>
                                    <option value="<?php echo htmlspecialchars( $value1["idCelular"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["modelo"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
