              ...
              <form method="POST" action="/admin/cadastrar-decretos/<?php echo htmlspecialchars( $decretos["idDecreto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-10">
                    <label for="exampleInputName">Nome de decretos </label>
                  ...
                  <div class="form-group col-md-10">
                    ...
                    <input type="text" class="form-control" id="exampleInputArquivo" name="txtNomeArquivo" value="<?php echo htmlspecialchars( $decretos["txtNomeArquivo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                  </div>
